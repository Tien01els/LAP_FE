...
const StudentSidebar = ({ isParent }) => {
    ...
    useEffect(() => {
        ...
        classId || (decodedToken && getClassOfStudent(decodedToken.userId));
    }, [decodedToken, classId, isParent]);
                ...
                <div className='relative' ref={wrapperRef}>
                    ...
                    >
                        <div className='flex flex-row items-center justify-between px-3 py-3'>
                            <span className='text-xl text-gray-600 font-[500] '>Notifications</span>
                            <span
                                onClick={seenAll}
