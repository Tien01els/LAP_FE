...
const TeacherTopicPage = lazy(() =>
  import('./pages/TeacherPages/TeacherTopicPage'),
)
      ...
      return (
        <>
          <>
            ...
            <Route path="/manage-topic" element={<TeacherTopicPage />} />
    ...
    if (roleID === 4) {
      return (
        <>
          ...
          />
          <Route path="/road-map" element={<RoadMap isParent />} />
        </>
      )
    }
    return (
