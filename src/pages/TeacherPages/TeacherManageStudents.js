...
const TeacherManageStudents = () => {
  ...
  const handleAddStudent = async () => {
    try {
      const newStudentOfClass = await axiosJWT.post(
        API_URL + `student/class/${classId}`,
        {
    ...
    <div className="flex flex-row h-screen">
      ...
      <div className="w-[60%] bg-white py-5 px-10 overflow-y-auto">
        <div className="flex flex-col gap-5 justify-center items-center">
          ...
          {/* swiper */}
          <div className="flex flex-col z-0 justify-center items-center select-none w-[750px]">
            <Swiper
              navigation={true}
              modules={[Navigation]}
