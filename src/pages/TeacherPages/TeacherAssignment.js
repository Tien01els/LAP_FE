...
const TeacherAssignment = () => {
  ...
  const handleSaveAssignment = async ({ noReview }) => {
    const assignment = {
    ...
    return navigate(`/assignment/${assignmentId}/review`)
  }
            ...
            <div className="flex flex-col w-full justify-center items-center gap-5">
              ...
              <div className="flex w-full items-center justify-center">
                <ConfirmModal
                  ...
                  message="If you want to review these questions? Click yes.
                                  If you want to go back the last page click no."
                  yesConfirm={() => handleSaveAssignment({ noReview: false })}
                  noConfirm={() => handleSaveAssignment({ noReview: true })}
                />
                <Button
                  className="w-[80%] border-none shadow-lg"
