...
const TeacherAssignment = () => {
  ...
  const [selectedDoTime, setSelectedDoTime] = useState('')
      ...
      <div className="flex flex-row gap-7 justify-center w-full h-full">
        <div className="w-[800px] bg-white rounded-lg shadow-lg flex flex-col justify-between my-4 px-10 py-5">
          <div className="flex flex-col gap-4">
            ...
            >
              {enableHint && (
                <div className="px-6 py-3 text-white flex flex-row gap-4 items-center bg-primary rounded-md overflow-hidden w-full whitespace-normal break-words">
