          ...
          {isTeacher && (
            <div className="flex flex-col">
              ...
              >
                ...
                {openMoreOption && (
                  <div className="absolute z-50 w-[125px] translate-y-14 -translate-x-12 border-t-2 text-sm border-primary bg-[#ffffff] flex flex-col divide-y shadow-lg rounded-b">
                    <div
