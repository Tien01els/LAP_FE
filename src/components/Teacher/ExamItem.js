...
const ExamItem = ({ val, currentAssignment, setCurrentAssignment, getAssignmentOfClass }) => {
    ...
    return (
      ...
      ${currentAssignment?.assignmentId === val?.assignmentId ? `bg-gray-200` : ``}`}
        >
            <div className='flex flex-col gap-3'>
                <span className='w-[250px] truncate'>{val?.assignment?.assignmentName}</span>
